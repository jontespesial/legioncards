...
const NewUnitCard = ({addNewCard}) => {
    ...
    return (
        <div className="card-unit placeholder noprint" onDragEnter={(e)=>HandleDrag(e, setDragActive)} onSubmit={(e) => e.preventDefault()}>
            ...
            {dragActive && <div id="drag-file-element" onDragEnter={(e)=>HandleDrag(e, setDragActive)} onDragLeave={(e)=>HandleDrag(e, setDragActive)} onDragOver={(e)=>HandleDrag(e, setDragActive)} onDrop={(e) => HandleDropJson(e, setDragActive, addNewCard)}></div>}
        </div>
    )
    /*
